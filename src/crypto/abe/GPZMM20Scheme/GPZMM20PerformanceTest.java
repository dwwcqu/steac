...
public class GPZMM20PerformanceTest {
	
	
	public static void main(String[] args) throws Exception {
		FileOutputStream os = new FileOutputStream("src//crypto//abe//Performance//GPZMM20//performance.xls");
		//创建Excel工作薄
		...
		for(int k = 1; k <= 10; k++) {
			...
			//群G上子群Gp的生成元
			Element gp = ElementUtils.getGenerator(pairing, generator, propertiesP, 0, 3).getImmutable();
